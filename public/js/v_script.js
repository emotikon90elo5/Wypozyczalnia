(function ($) {
  $(document).ready(function () {
    ...
    function uploadImage() {
      ...
      var uploader = $('<input type="file" accept="image/png,image/jpeg" />')
      var images = $('.images')
      ...
      uploader.on('change', function () {
          ...
          reader.onload = function(event) {
            images.prepend('<div class="img" style="background-image: url(\'' + event.target.result + '\');" rel="'+ event.target.result  +'"><span class="remove">X</span></div>')
          }
